...
const unsigned int SET_DEVICE =(unsigned int)7;
const unsigned int EPOCH_TP =(unsigned int)1000;
const unsigned int BATCH_SIZE =(unsigned int)65536;
const unsigned long long WAREHOUSE_SIZE =(unsigned long long)64;
const unsigned int NEWORDER_PERCENT =(unsigned int)0;
...
const unsigned int SLOT_SIZE = (unsigned int)2;
const unsigned int STREAM_SIZE = (unsigned int)EPOCH_TP;
// const unsigned int STREAM_SIZE = (unsigned int)1;
...
const unsigned int PRE_GEN_EPOCH = (unsigned int)(EPOCH_TP);
