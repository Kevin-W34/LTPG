...
const unsigned int SET_DEVICE =(unsigned int)2;
const unsigned int EPOCH_TP =(unsigned int)5000;
const unsigned int BATCH_SIZE =(unsigned int)1048576;
const unsigned long long WAREHOUSE_SIZE =(unsigned long long)1024;
