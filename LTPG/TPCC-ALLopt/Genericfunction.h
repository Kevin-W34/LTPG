...
/// @brief only called by get_c_id
/// @param C_LAST  C_LAST
/// @param distance result
/// @param C_NAME_INDEX_START  start location of c_name index
/// @param C_NAME_INDEX_LENGTH  length of c_name index
/// @param snapshot
/// @return
__device__ unsigned int __FIND_CID_INDEX(unsigned int C_LAST,
                                         unsigned int distance,
                                         unsigned int *C_NAME_INDEX_START,
                                         unsigned int C_NAME_INDEX_LENGTH,
...
/// @param column           which attribute
/// @param Loc              location in the table
/// @param query_cnt        how many quries in the same type
/// @param table_size       size of the target table
/// @param column_size      how many attributes are there in the table
/// @param new_value        if write, give the new value
/// @param set_local_set    local read/write set
...
/// @brief write data from table, only used for record local set
/// @param NO 
/// @param OP 
/// @param column 
/// @param Loc 
...
/// @brief 
/// @param isFrequent 
/// @param NO           which transaction instance
/// @param OP           which operation in transaction instance
/// @param query_cnt    How many transaction instances are there for the current transaction type
/// @param TID          transaction id
/// @param Loc          data location in data table
/// @param log_loc_up   The upper 32 bits of a 64-bit data
/// @param log_loc_down The lower 32 bits of a 64-bit data
/// @param log 
/// @return 
...
/// @brief check conflicts in the batch of transactions
/// @param isFrequent 
/// @param NO 
/// @param Loc 
/// @param TID 
