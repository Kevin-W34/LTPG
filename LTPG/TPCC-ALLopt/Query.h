...
public:
    ...
    {// old statistic executed queries
        // copy_to_host();
        unsigned int n_ID = 0;
        unsigned int p_ID = 0;
    ...
    /// @brief initial neworder and make them in a batch
    ...
    /// @brief initial payment and make them in a batch
