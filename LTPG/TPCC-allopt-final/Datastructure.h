...
struct LOG
{
    unsigned int LOG_WAREHOUSE_R[WAREHOUSE_SIZE * 32];
    unsigned int LOG_WAREHOUSE_W[WAREHOUSE_SIZE * 32];
    unsigned int LOG_DISTRICT_R[DISTRICT_SIZE * 32];
    unsigned int LOG_DISTRICT_W[DISTRICT_SIZE * 32];
